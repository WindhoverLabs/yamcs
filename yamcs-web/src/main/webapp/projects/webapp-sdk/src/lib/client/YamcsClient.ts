...
import {
  ...
  GetCommandIndexOptions,
  GetCompletenessIndexOptions,
  GetEventIndexOptions,
  GetGapsOptions,
...
export default class YamcsClient implements HttpHandler {
  ...
  async getParameterIndex(
    instance: string,
    options: GetParameterIndexOptions,
  ): Promise<IndexGroup[]> {
  ...
  async getCommandIndex(
    instance: string,
    options: GetCommandIndexOptions,
  ): Promise<IndexGroup[]> {
  ...
  async requestPlayback(
    instance: string,
    link: string,
    options: RequestPlaybackRequest,
  ) {
